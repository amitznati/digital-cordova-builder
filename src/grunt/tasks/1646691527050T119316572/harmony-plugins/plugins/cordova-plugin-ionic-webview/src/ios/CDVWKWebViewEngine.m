...
#import "SecureHTTPURLProtocol.h"
...
{
    // NSLog(@"ofir");
   // delegate to SecureURLProtocol that is already handling for UIWebView and all other URLConnection based https transations
    //[SecureHTTPURLProtocol setCertificatePinningWithContentPath];
    [SecureHTTPURLProtocol didReceiveAuthenticationChallenge:challenge completionHandler:completionHandler];
