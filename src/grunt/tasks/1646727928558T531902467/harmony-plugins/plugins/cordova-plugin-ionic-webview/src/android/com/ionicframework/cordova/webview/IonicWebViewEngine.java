...
public class IonicWebViewEngine extends SystemWebViewEngine {
    ...
    public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
      switch (error.getPrimaryError()) {
        case SslError.SSL_UNTRUSTED:
          Log.e("SSL Pinning", "SslError : The certificate authority is not trusted.");
          break;
        case SslError.SSL_EXPIRED:
          Log.e("SSL Pinning", "SslError : The certificate has expired.");
          break;
        case SslError.SSL_IDMISMATCH:
          Log.e("SSL Pinning", "The certificate Hostname mismatch.");
          break;
        case SslError.SSL_NOTYETVALID:
          Log.e("SSL Pinning", "The certificate is not yet valid.");
          break;
      }
      CertificateInjector oEmbeddedCertificateTrustManager = CertificateInjector.getInstance();
      try {
        oEmbeddedCertificateTrustManager.checkServerTrusted(error.getCertificate());
        handler.proceed();
  ...
  public void setServerBasePath(String path) {
    // changing global content path
    CertificateInjector.CONTENT_PATH = path;
